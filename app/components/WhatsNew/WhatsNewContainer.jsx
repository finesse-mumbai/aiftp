...
function WhatsNewContainer() {
  return (
    <div className="min-h-screen bg-white relative flex items-center justify-center">
        ...
        <div className="mx-auto w-full max-w-screen-2xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-6 px-3 md:px-12 mt-6 md:mt-12">
